...
# Будни студентов
  ...
  - Мы с Васей работали над разными частями программы.\
    ...
    - __Кто, что и где поменял, и как это собрать воедино?__

# Будни программистов

  - Старшим инженером был реализован и отлажен программный компонент.\
    Потом младший инженер делал какие-то мелкие правки. И все поломал!\
    Сейчас в программе ошибка, но чтобы ее найти
    - __Нужно знать, какие участки кода он менял!__
  - Мы втроем пишем большую систему. Каждый реализует свой модуль.
    - __Где последняя и полная версия системы?__
  - Месяц назад мы выпустили gold release.\
    Сейчас мы активно работаем над новым релизом, который должен выйти через 3 месяца.\
    Однако, заказчик нашел критическую ошибку и просит выдать ему обновление.
    - __Как выдать стабильное обновление__, если система уже наполовину разобрана?

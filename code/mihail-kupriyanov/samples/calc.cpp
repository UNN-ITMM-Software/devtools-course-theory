...
int main() {
    ...
    // создаем и считаем значения для ряда
    // распределения значения выпадающего на игральном кубике
    ...
    printf("\n%s",
    "ряд распределения значения выпадающего на игральном кубике: ");

    PrintSample(sample);
    MakeCalc(&mqCalc, sample);
    sample.clear();

    // создаем и считаем значения для некоторого
    // некорректного ряда распределения

...
void ComplexCalculator::Output(char *str)
{
	...
	sprintf(str,(str1.c_str()));
}
ComplexCalculator ComplexCalculator::Add(ComplexCalculator first, ComplexCalculator second)
{
...
ComplexCalculator ComplexCalculator::Sub(ComplexCalculator first, ComplexCalculator second)
{
	ComplexCalculator temp(0,0);
	temp.real=first.GetReal()-second.GetReal();
	temp.imaginary=first.GetImaginary()-second.GetImaginary();
...
ComplexCalculator ComplexCalculator::Multi(ComplexCalculator first, ComplexCalculator second)
{
	ComplexCalculator temp(0,0);
	temp.real=first.GetReal()*second.GetReal()-first.GetImaginary()*second.GetImaginary();
	temp.imaginary=first.GetReal()*second.GetImaginary()+first.GetImaginary()*second.GetReal();
	return temp;
}
